...
import girldev from '../../images/girldev.avif';
      ...
      <NavbarContainer>
        <NavLogo>
          <img 
            src={girldev} 
            alt="Girl Developer" 
            style={{ width: '50px', height: '50px', marginLeft: '10px', border: '2px solid #fff', borderRadius: '50%' }} 
          />
        </NavLogo>
        ...
        {isOpen && (
          <MobileMenu isOpen={isOpen}>
            ...
            <MobileLink href='#certificates' onClick={() => setIsOpen(!isOpen)}>Certificates</MobileLink>
